    ...
    <div class="max-w-full h-screen overflow-y-auto transition ease-linear duration-300 dark:bg-[#10192D]">
        <div class="px-6 pt-[15px] h-screen ">
            ...
            <div class=" my-4 p-4">
                  ...
                  <p class="text-sm text-[400] pt-4 text-[#8E9BAE]">Enter the 4-digit code  we just send to your phone number 
                    <span class="text-[#10192D]">{{ pinia.state.user?.phone }}</span></p>
            </div>
