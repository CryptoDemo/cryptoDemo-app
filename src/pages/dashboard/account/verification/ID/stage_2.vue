<template>
    ...
    <div class="px-6 py-[6px] bg-[#ffff]   dark:bg-[#10192D]  min-h-screen">
        ...
        <p class="pt-6">Your phone number is verified.</p>
        
       
        <div class="mb-5 mt-4">

            <div  class="flex items-center">
                <button  disabled    id="dropdown-phone-button" data-dropdown-toggle="dropdown-phone" class="flex-shrink-0  
                ...
                <div   id="dropdown-phone" class="z-10 hidden w-full bg-white dark:bg-[#10192D]   rounded-lg 
                    mx-4 px-4">
                        ...
                        <div class="relative">
                            ...
                            <input v-model.trim="searchInput" type="search" id="default-search" class="block w-full my-3  p-4 ps-10 text-sm focus:border-0 
                                ...
                                placeholder="Search country codes..." required>
                        </div>

                    <ul v-for="i in filteredItem.length? filteredItem : phone_numbers1"  class="pb-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-phone-button">
                        <li >
                            <button @click="selectedNumber = i.code ;selectedIcon= i.icon ;open = false " type="button" class="inline-flex px-4 w-full  py-2 text-sm hover:rounded-2xl text-gray-700 hover:bg-gray-100 dark:text-gray-200  dark:hover:text-white" role="menuitem">
                ...
                <div class="relative w-full z-20">
                    <input type="phone" id="phone-input" class="block py-[16px] px-[17px] w-full z-20 text-sm outline-none
                        ...
                        " pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-456-7890" required disabled>
                </div>
            </div>
        ...
        <button @click.prevent="navigateTo('/dashboard/account/verification/ID/stage_3')" class="btn-primary w-full mt-[77px]">Verify my ID</button>
