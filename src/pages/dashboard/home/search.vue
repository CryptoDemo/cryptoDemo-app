<template>
    ...
    <div class="h-screen pb-20 overflow-y-scroll bg-[#ffff] font-['Poppins']   dark:bg-[#10192D]  w-full px-6">
        ...
        <div v-for="i in 3" class="mt-[24px]">
            ...
            <div class="flex justify-between items-center mb-[27px]">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex flex-col ml-[16px]">
                        ...
                        <span class="text-[#8E9BAE] text-[12px] font-[400]">LTC</span>
                    </div>
                </div>
...
const coin_lists = [
  { name: 'Ethereum',code:'ETH',amount:200000, percentage:'',id:1 },
  { name: 'Bitcoin', code:'BTC',amount:18965, id: 2 },
  { name: 'XRP',code:'XRP', amount:23341, id: 3 },
  { name: 'Dash',code:'XRP', amount:11232, id: 4 },
  { name: 'Binance',code:'BNB', amount:43231, id: 5 },
];
