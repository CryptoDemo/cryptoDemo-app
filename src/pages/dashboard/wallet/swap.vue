        ...
        <div class="mt-[16px]">
            ...
            <div class="flex flex-col">
                ...
                <div class="relative">
                    ...
                    <div v-show="show_wallet_list1" class="absolute right-1.5 flex z-50 flex-col bg-[#131D35]  
                    px-2 max-h-[120px] overflow-y-auto  rounded">
        ...
        <div class="mt-[16px]">
            ...
            <div class="flex flex-col">
                ...
                <div class="relative">
                    ...
                    <div v-show="show_wallet_list2" class="absolute right-0 flex z-40 flex-col bg-[#131D35] 
