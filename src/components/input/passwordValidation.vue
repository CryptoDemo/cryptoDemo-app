    ...
    <div>
        <div class="relative">
          <input
            ...
            @focusout="hint = false"
            @input="checkPassword"
            :class="!props.errorlog ? 'border-[#E33E38] focus:border-[#E33E38]  focus:ring-[#E33E38] dark:border-[#E33E38] dark:focus:border-[#E33E38]  dark:focus:ring-[#E33E38]' : ''"
          />
